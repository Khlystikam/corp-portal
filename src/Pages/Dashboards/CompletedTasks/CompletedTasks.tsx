...
const CompletedTasks: React.FC = () => {
    ...
    const completedTasks = useSelector(
        (state: RootState) => state.completedTask.completedTasks
    ) || [];
    ...
    const generalClass =
        "completed-task-item flex flex-row justify-start items-center w-1/1 h-5 gap-3 p-5 ";
    const classTaskElementsMade =
        generalClass +
        "bg-green-700 rounded-md hover:shadow-md cursor-pointer";
    const classTaskElementsNoMade =
        generalClass +
        "rounded-md hover:shadow-md bg-red-900/50 cursor-pointer";
