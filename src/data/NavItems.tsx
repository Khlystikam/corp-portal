...
export const navItemUser: NavItemUser[] = [
    {
        id: 1,
        name: 'Dashboards',
        href: '/projects/project-1/dashboards',
        svg: (
            <svg
    ...
    },
    {
        id: 3,
        name: 'E-commerce',
        href: '/projects/project-1/e-commerce',
        svg: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
    ...
    },
    {
        id: 4,
        name: 'Colleagues',
        href: '/projects/project-1/colleagues',
        svg: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
    ...
    },
    {
        id: 5,
        name: 'Projects',
        href: '/projects/project-1/projects',
        svg: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
    ...
    },
    {
        id: 6,
        name: 'Mailing',
        href: '/projects/project-1/mailing',
        svg: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
...
export const navItemTechnical: navItemTechnical[] = [
    {
        id: 8,
        name: 'Support',
        href: '/projects/project-1/support',
        svg: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
